...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: ./attention.sh [--config-file FILE] [--max-jobs N] [--filter PATTERN] [--dry-run] [--epoch EPOCH]"
            exit 1
            ;;
    esac
done
